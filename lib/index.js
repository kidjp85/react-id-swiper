...
var ReactIdSwiper = function (_React$Component) {
  ...
  function ReactIdSwiper(props) {
    ...
    (0, _lodash4.default)(_this, 'validateClass', 'renderScrollBar', 'renderPagination', 'renderNextButton', 'renderPrevButton', 'renderContent');
    return _this;
  }
  ...
  _createClass(ReactIdSwiper, [{
    ...
    value: function componentDidMount() {
      this.swiper = (0, _swiper2.default)(_reactDom2.default.findDOMNode(this), (0, _lodash2.default)({}, this.props));
    }
  }, {
    ...
    value: function componentWillReceiveProps(nextProps) {
      if (this.props.rebuildOnUpdate && typeof this.swiper !== 'undefined') {
        this.swiper.destroy(true, true);
        this.swiper = (0, _swiper2.default)(_reactDom2.default.findDOMNode(this), (0, _lodash2.default)({}, nextProps));
      }
    }
  }, {
    key: 'validateClass',
