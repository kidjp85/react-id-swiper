...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return src_ReactIdSwiper; });
...
function (_Component) {
  ...
  _createClass(ReactIdSwiper, [{
    ...
    value: function getActiveSlideIndexFromProps() {
      ...
      var id = 0;
      external_React_default.a.Children.forEach(this.props.children, function (child) {
        if (child) {
    ...
    value: function buildSwiper() {
      this.swiper = new swiper_default.a(external_ReactDOM_default.a.findDOMNode(this), object_assign_default()({}, this.props));
    }
  }, {
    key: "rebuildSwiper",
    ...
    value: function renderContent(e) {
      ...
      return external_React_default.a.cloneElement(e, _objectSpread({}, e.props, {
    ...
    value: function render() {
      ...
      return external_React_default.a.createElement(ContainerEl, {
        className: containerClass,
        dir: rtl && 'rtl'
      }, parallax && parallaxEl && renderParallax(this.props), external_React_default.a.createElement(WrapperEl, {
        className: wrapperClass
      }, external_React_default.a.Children.map(children, this.renderContent)), pagination && pagination.el && renderPagination(this.props), scrollbar && scrollbar.el && renderScrollbar(this.props), navigation && navigation.nextEl && renderNextButton(this.props), navigation && navigation.prevEl && renderPrevButton(this.props));
    }
  }]);
...
_defineProperty(src_ReactIdSwiper, "defaultProps", {
